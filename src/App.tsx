...
import BundlePerformancePage from "./pages/inventory/BundlePerformancePage";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/crm/inventory/bundles/:id/performance" element={<Protected><BundlePerformancePage /></Protected>} />
