  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from("bundles")
        .select("*, products(name, name_ar, image_url, sale_price, cost_price, shipping_price, category_id, sku, slug, product_number, is_published, is_featured, categories!products_category_id_fkey(name)), bundle_items(*, product_variations(name, sku))")
