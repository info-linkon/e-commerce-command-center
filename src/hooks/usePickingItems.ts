...
const pickingItemsSelect = "*, order_items(id, quantity, variation_id, bundle_variation_id, product_variations(id, name, name_ar, sku, products(name, name_ar, sku, image_url))), product_variations(id, name, name_ar, sku, products(name, name_ar, sku, image_url))";
