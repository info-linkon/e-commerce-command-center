...
export default function WebAboutPage() {
  ...
  const stats = [
    ...
    { end: 1000, suffix: "+", desc: "عميل سعيد" },
    { end: 5, suffix: "+", desc: "سنوات خبرة" },
    { end: 100, suffix: "%", desc: "رضا العملاء" },
  ];

  const values = [
    { title: "جودة مضمونة", desc: "نضمن لك أعلى مستويات الجودة في كل منتج نقدمه" },
    { title: "خدمة متميزة", desc: "فريق دعم متخصص جاهز لمساعدتك في أي وقت" },
    { title: "أسعار تنافسية", desc: "نقدم أفضل الأسعار مع الحفاظ على الجودة العالية" },
  ];

  const faqs = [
    { q: "كيف يمكنني الطلب؟", a: "يمكنك تصفح المنتجات وإضافتها إلى السلة ثم إتمام الطلب بسهولة" },
    { q: "ما هي مدة التوصيل؟", a: "نوصل خلال 2-5 أيام عمل لمعظم المناطق" },
    { q: "هل يمكنني إرجاع المنتج؟", a: "نعم، يمكنك إرجاع المنتج خلال 14 يوم من تاريخ الاستلام" },
  ];
      ...
      <section className="container py-14 md:py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed whitespace-pre-line">
            {content.body || "الوجهة — متجر إلكتروني متخصص في تقديم منتجات أصلية بأفضل الأسعار مع خدمة توصيل سريعة وموثوقة لجميع المناطق."}
          </div>
        </div>
      </section>
